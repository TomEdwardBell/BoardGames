...
class Options: # Use this to change the options
    def __init__(self):
        ...
        self.color_selection_size = 100
        # ^ Size of the bit at the bottom where you select your colors
...
class MainGame:
    ...
    def clicked(self, coords):
        cc = self.click_color
        old_color = self.ui.board[coords].color
...
class Grid(QtWidgets.QMainWindow):
    def __init__(self, parent):
        ...
        self.margin = (30, int(self.options.color_selection_size), 0, 0) # Top margin, Bottom margin, Left Margin, Right Margin
        self.borders = (0, 0)
    ...
    def place_color_selection_buttons(self):
        ...
        for color in range(len(self.options.colors)):
            ...
            newy = self.height() - self.options.color_selection_size/2 - square_sizes/2
            c.move(newx, newy)
